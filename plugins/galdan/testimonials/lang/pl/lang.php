...
return [
    'plugin' => [
        'name' => 'Aktualności i testimonialsletter',
        'description' => 'Plugin do zarządzania aktualnościami i testimonialsletterem.',
        'author' => 'Gergő Szabó'
    ],
    'menu' => [
        'testimonials' => 'Subskrypcja',
        'posts' => 'Posty',
        'testimonials' => 'Subskrybenci',
    ...
    'title' => [
        'posts' => 'post',
        'testimonials' => 'Subskrybent'
    ],
    'new' => [
        'posts' => 'Nowy post',
        'testimonials' => 'Nowy subskrybent'
    ],
    'stat' => [
        'posts' => 'post|blogach',
        'view' => 'widok',
    ...
    'widget' => [
        ...
        'testimonials' => 'Aktualności - Subskrybenci',
    ...
    'permission' => [
        ...
        'testimonials' => 'Zarządzaj subskrybentami',
    ...
    'messages' => [
        'unsubscribed' => 'We successfully unsubscribed you from our testimonialsletter.',
        'not_subscribed' => 'You do not have subscribed account.',
        'subscribed' => 'Thank you for your subscription to our testimonialsletter!'
    ]
];
