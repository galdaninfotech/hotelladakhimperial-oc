...
return [
    'plugin' => [
        'name' => 'Testimonials und Testimonialsletters',
        'description' => 'Einfaches Testimonials und Testimonialsletter plugin.',
        'author' => 'Gergő Szabó'
    ],
    'menu' => [
        'testimonials' => 'Testimonials',
        'posts' => 'Nachrichten',
        'testimonials' => 'Abonnenten',
    ...
    'widget' => [
        'posts' => 'Testimonials - Nachrichten',
        'testimonials' => 'Testimonials - Abonneten',
    ...
    'permission' => [
        ...
        'testimonials' => 'Abonnenten verwalten',
    ...
    'messages' => [
        'unsubscribed' => 'Wir haben Sie erfolgreich aus den Testimonialsletter ausgetragen.',
        'not_subscribed' => 'Sie haben hier keinen Testimonialsletter abonniert.',
        'subscribed' => 'Danke, dass Sie unseren Testimonialsletter abonniert haben.'
    ]
];
