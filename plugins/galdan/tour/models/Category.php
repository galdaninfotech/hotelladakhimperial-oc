...
class Category extends Model
{
    ...
    public $table = 'galdan_tour_categories';
    ...
    public $rules = [
        'name' => 'required',
        'slug' => 'required|between:3,64|unique:galdan_tour_categories',
        'code' => 'unique:galdan_tour_categories',
    ];
    ...
    //     'posts' => ['Galdan\Tour\Models\Post',
    //         'table' => 'galdan_tour_posts_categories',
    ...
    public static function getMenuTypeInfo($type)
    {
        ...
        if ($result) {
            ...
            foreach ($pages as $page) {
                if (!$page->hasComponent('tourPosts')) {
                    continue;
                }
                 ...
                 */
                $properties = $page->getComponentProperties('tourPosts');
    ...
    public static function resolveMenuItem($item, $url, $theme)
    {
        ...
        elseif ($item->type == 'all-tour-categories') {
            $result = [
                'items' => []
            ];
