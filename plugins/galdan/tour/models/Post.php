...
class Post extends Model
{
    ...
    public $rules = [
        'title' => 'required',
        'slug' => ['required', 'regex:/^[a-z0-9\/\:_\-\*\[\]\+\?\|]*$/i', 'unique:galdan_tour_posts']
    ];
    ...
    public $belongsTo = [
        ...
        'category' => ['Galdan\Tour\Models\Category'],
        'itinerary' => ['Galdan\Tour\Models\Itinerary'],

    ];

    public $hasMany = [
        'bookings' => ['\Galdan\Bookings\Models\Booking'],
        'clients' => ['\Galdan\Clients\Models\Client'],
        'tasks' => ['\Galdan\Tour\Models\Task']
    ];
    ...
    public function filterFields($fields, $context = null)
    {
        ...
        if (!$user->hasAnyAccess(['galdan.tour.access_publish'])) {
    ...
    public function afterValidate()
    {
        if ($this->published && !$this->published_at) {
            throw new ValidationException([
               'published_at' => Lang::get('galdan.tour::lang.post.published_validation')
            ]);
        }
    ...
    {
        return ($this->user_id == $user->id) || $user->hasAnyAccess(['galdan.tour.access_other_posts']);
    }
    ...
    public function scopeListFrontEnd($query, $options)
    {
        ...
        if ($category !== null) {
            ...
            $category = $category->getAllChildrenAndSelf()->lists('id');
            // dd($categories);
    ...
    public static function getMenuTypeInfo($type)
    {
        ...
        if ($result) {
            ...
            foreach ($pages as $page) {
                 ...
                 */
                $properties = $page->getComponentProperties('tourPost');
    ...
    public static function resolveMenuItem($item, $url, $theme)
    {
        ...
        elseif ($item->type == 'all-tour-posts') {
            $result = [
                'items' => []
            ];
    ...
    public function scopeFilterItinerary($query, $itinerary)
    {
        return $query->whereHas('itinerary', function($q) use ($itinerary) {
            $q->whereIn('id', $itinerary);
        });
    }
