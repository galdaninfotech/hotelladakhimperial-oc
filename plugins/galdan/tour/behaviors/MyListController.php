<?php namespace Galdan\Tour\Behaviors;
 ...
 */
class MyListController extends ControllerBehavior
{
    /**
    ...
    public function makeList($definition = null)
    {
         ...
         */
        $widget = $this->makeWidget('Galdan\Tour\Widgets\Lists', $columnConfig);
        ...
        if (isset($listConfig->filter)) {
            ...
            $filterWidget = $this->makeWidget('Galdan\Tour\Widgets\Filter', $filterConfig);
    ...
    public static function extendListColumns($callback)
    {
        ...
        Event::listen('Galdan.Tour.list.extendColumns', function ($widget) use ($calledClass, $callback) {
