<?php namespace Galdan\Tour\Widgets;
...
class Table extends WidgetBase
{
    ...
    public function init()
    {
        ...
        if (Request::method() == 'POST' && $this->isTourDataSource()) {
    ...
    public function prepareVars()
    {
        ...
        $isTourDataSource = $this->isTourDataSource();

        $this->vars['clientDataSourceClass'] = $isTourDataSource ? 'client' : 'server';
        $this->vars['data'] = json_encode($isTourDataSource
    ...
    protected function isTourDataSource()
    {
        return $this->dataSource instanceof \Backend\Widgets\Table\TourMemoryDataSource;
    }
