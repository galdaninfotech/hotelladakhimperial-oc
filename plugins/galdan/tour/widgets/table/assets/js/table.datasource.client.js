/*
 * Tour memory data source for the table control.
 */
+function ($) { "use strict";
    ...
    Tour.prototype = Object.create(BaseProto)
     ...
     * widget options.
     */
    Tour.prototype.getRecords = function(offset, count, onSuccess) {
        if (!count) {
            // Return all records
     ...
     * The onSuccess callback parameters: records, totalCount.
     */
    Tour.prototype.createRecord = function(recordData, placement, relativeToKey, offset, count, onSuccess) {
        if (placement === 'bottom') {
     ...
     * - recordData - the record fields.
     */
    Tour.prototype.updateRecord = function(key, recordData) {
     ...
     * The onSuccess callback parameters: records, totalCount.
     */
    Tour.prototype.deleteRecord = function(key, newRecordData, offset, count, onSuccess) {
        var recordIndex = this.getIndexOfKey(key)
    ...
    Tour.prototype.getIndexOfKey = function(key) {
    ...
    Tour.prototype.getAllData = function() {
        return this.data
    }

    $.oc.table.datasource.client = Tour
}(window.jQuery);