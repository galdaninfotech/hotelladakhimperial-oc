# Tour-side table widget (table.xxx.js)
...
### Tour-side performance and memory usage considerations
...
### Tour memory data source ($.oc.table.datasource.client)
...
* `client` = \Backend\Widgets\Table\TourMemoryDataSource
...
- validation - defines the column client-side validation rules. See the **Tour-side validation** section below.
