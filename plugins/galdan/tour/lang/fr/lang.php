...
return [
    'plugin' => [
        'name' => 'Tour',
        'description' => 'Une plateforme de tour robuste.'
    ],
    'tour' => [
        'menu_label' => 'Tour',
        'menu_description' => 'Gestion d’articles de tour',
        'posts' => 'Articles',
        'create_post' => 'article de tour',
    ...
    'posts' => [
        'list_title' => 'Gérer les articles du tour',
    ...
    'menuitem' => [
        'tour_category' => 'Catégories du tour',
        'all_tour_categories' => 'Toutes les catégories du tour'
    ],
    'settings' => [
        ...
        'post_title' => 'Article',
        'post_description' => 'Affiche un article de tour sur la page.',
        ...
        'posts_description' => 'Affiche une liste des derniers articles de tour sur la page.',
        ...
        'rssfeed_tour' => 'Page du tour',
        'rssfeed_tour_description' => 'Nom de la page principale du tour pour générer les liens. Cette propriété est utilisé par le composant dans le partial.',
        'rssfeed_title' => 'Flux RSS',
        'rssfeed_description' => 'Génère un Flux RSS contenant les articles du tour.'
    ]
];
