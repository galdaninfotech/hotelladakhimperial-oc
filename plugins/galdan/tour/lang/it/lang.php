...
return [
    'plugin' => [
        'name' => 'Tour',
        'description' => 'Una solida piattaforma di tourging.'
    ],
    'tour' => [
        'menu_label' => 'Tour',
        'menu_description' => 'Gestisci i post',
        'posts' => 'Post',
        'create_post' => 'post del tour',
        'categories' => 'Categorie',
        'create_category' => 'categorie del tour',
        'tab' => 'Tour',
    ...
    'categories' => [
        'list_title' => 'Gestisci le categorie del tour',
    ...
    'category' => [
        ...
        'return_to_categories' => 'Ritorna all\'elenco delle categorie del tour',
        'reorder' => 'Riordino Categorie'
    ],
    'settings' => [
        'category_title' => 'Elenco Categorie',
        'category_description' => 'Mostra un\'elenco delle categorie del tour sulla pagina.',
        'category_slug' => 'Slug categoria',
        'category_slug_description' => "Cerca la categoria del tour usando lo slug fornito. Questa proprietà è usata dal componente parziale di default per segnare la categoria attualmente usata.",
