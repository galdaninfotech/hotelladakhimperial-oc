...
return [
    'plugin' => [
        'name' => 'Tour',
        'description' => 'Solidna platforma tourera'
    ],
    'tour' => [
        'menu_label' => 'Tour',
        'menu_description' => 'Zarządzaj tourowymi postami',
        'posts' => 'Posty',
        'create_post' => 'utwórz post',
        'categories' => 'Kategorie',
        'create_category' => 'kategoria toura',
        'tab' => 'Tour',
        'access_posts' => 'Zarządzaj tourowymi postami',
        'access_categories' => 'Zarządzaj tourowymi kategoriami',
        'access_other_posts' => 'Zarządzaj tourowymi postami innych użytkowników',
    ...
    'posts' => [
        'list_title' => 'Zarządzaj tourowymi postami',
    ...
    'settings' => [
        ...
        'category_description' => 'Wyświetla listę tourowych kategorii na stronie.',
