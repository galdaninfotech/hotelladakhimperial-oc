...
return [
    'plugin' => [
        'name' => 'Tour',
        'description' => 'Robustní tourová platforma.'
    ],
    'tour' => [
        'menu_label' => 'Tour',
        'menu_description' => 'Správa tourových příspěvků',
        'posts' => 'Příspěvky',
        'create_post' => 'Příspěvek',
        'categories' => 'Kategorie',
        'create_category' => 'Kategorie příspěvků',
        'tab' => 'Tour',
        'access_posts' => 'Správa tourových příspěvků',
        'access_categories' => 'Správa tourových kategorií',
    ...
    'posts' => [
        'list_title' => 'Správa tourových příspěvků',
    ...
    'categories' => [
        'list_title' => 'Správa tourových kategorií',
    ...
    'category' => [
        ...
        'return_to_categories' => 'Zpět na seznam tourových kategorií',
        'reorder' => 'Změnit pořadí',
    ],
    'menuitem' => [
        'tour_category' => 'Tourová kategorie',
        'all_tour_categories' => 'Všechny tourové kategorie',
    ],
    'settings' => [
        'category_title' => 'Seznam kategorií',
        'category_description' => 'Zobrazí na stránce seznam tourových kategorií.',
        'category_slug' => 'URL kategorie',
        'category_slug_description' => "Najde tourovou kategorii s tímto URL. Používá se pro zobrazení aktivní kategorie.",
        'category_display_empty' => 'Zobrazit prázdné kategorie',
        'category_display_empty_description' => 'Zobrazit kategorie bez tourových příspěvků.',
        ...
        'post_description' => 'Zobrazí tourový příspěvek na stránce.',
        ...
        'rssfeed_description' => 'Vygeneruje RSS kanál který obsahuje tourové příspěvky.',
    ]
];
