...
return [
    'plugin' => [
        'name' => 'Tour',
        'description' => 'Sağlam tour platformu.'
    ],
    'tour' => [
        'menu_label' => 'Tour',
        'menu_description' => 'Gönderileri Yönet',
        'posts' => 'Gönderiler',
        'create_post' => 'tour gönderisi',
        'categories' => 'Kategoriler',
        'create_category' => 'tour kategorisi',
        'tab' => 'Tour',
        'access_posts' => 'Gönderileri yönetebilsin',
        'access_categories' => 'Tour kategorilerini yönetebilsin',
    ...
    'posts' => [
        'list_title' => 'Tour gönderilerini yönet',
    ...
    'menuitem' => [
        'tour_category' => 'Tour kategorisi',
        'all_tour_categories' => 'Tüm tour kategorileri',
        'tour_post' => 'Tour gönderisi',
        'all_tour_posts' => 'Tüm tour gönderileri',
    ...
    'settings' => [
        ...
        'category_slug_description' => "Verilen kısa URLi kullanarak tour kategorisini görüntüle. Bu özellik şu anki aktif kategoriyi işaretlemek için varsayılan kısmi bileşeni tarafından  kullanılır",
        ...
        'rssfeed_tour' => 'Tour sayfası',
        'rssfeed_tour_description' => 'Linkleri üretmek için tour sayfasının adını girin. Bu bilgi, ana component için kullanılacak.',
        'rssfeed_title' => 'RSS Beslemesi',
        'rssfeed_description' => 'Tour içerisindeki gönderileri veren RSS beslemesi oluşturur.'
    ]
];
