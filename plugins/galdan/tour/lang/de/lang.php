...
return [
    'plugin' => [
        'name' => 'Tour',
        'description' => 'Eine robuste Tour Plattform.'
    ],
    'tour' => [
        'menu_label' => 'Tour',
        'menu_description' => 'Tour Artikel bearbeiten',
        'posts' => 'Artikel',
        'create_post' => 'Tour Artikel',
        'categories' => 'Kategorien',
        'create_category' => 'Tour Kategorie',
        'tab' => 'Tour',
        'access_posts' => 'Tour Artikel verwalten',
        'access_categories' => 'Tour Kategorien verwalten',
        'access_other_posts' => 'Tour Artikel anderer Benutzer verwalten',
        'access_import_export' => 'Tour Artikel importieren oder exportieren',
    ...
    'posts' => [
        'list_title' => 'Tour Artikel verwalten',
    ...
    'categories' => [
        'list_title' => 'Tour Kategorien verwalten',
    ...
    'menuitem' => [
        'tour_category' => 'Tour Kategorie',
        'all_tour_categories' => 'Alle Tour Kategorien',
        'tour_post' => 'Tour Artikel',
        'all_tour_posts' => 'Alle Tour Artikel'
    ],
    'settings' => [
        'category_title' => 'Tour Kategorie-Übersicht',
        'category_description' => 'Zeigt eine Tour Kategorien-Übersicht.',
        ...
        'post_title' => 'Tour Artikel',
        'post_description' => 'Zeigt einen Tour Artikel auf der Seite.',
        ...
        'posts_title' => 'Tour Artikel-Übersicht',
        ...
        'rssfeed_tour' => 'Tour Seite',
        'rssfeed_tour_description' => 'Name der Artikel-Seiten-Datei für die Links. Dieser Wert für von der Standard-Komponente verwendet.',
        'rssfeed_title' => 'RSS-Feed',
        'rssfeed_description' => 'Erstellt einen RSS-Feed mit Artikeln aus dem Tour.'
    ]
];
