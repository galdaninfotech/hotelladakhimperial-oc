...
use Galdan\Email\Classes\ImapClient\Message\Part;
use Galdan\Email\Classes\ImapClient\Message\Attachment;
use Galdan\Email\Classes\ImapClient\Message\Headers;
use Galdan\Email\Classes\ImapClient\Message\EmailAddress;

use Galdan\Email\Classes\ImapClient\Exception\MessageDoesNotExistException;
use Galdan\Email\Classes\ImapClient\Exception\MessageDeleteException;
use Galdan\Email\Classes\ImapClient\Exception\MessageMoveException;

//now
// require(DOCROOT.'/modules/email/imapclient/Message/Part.php');
// require(DOCROOT.'/modules/email/imapclient/Message/Attachment.php');
// require(DOCROOT.'/modules/email/imapclient/Message/Headers.php');

//now
// require(DOCROOT.'/modules/email/imapclient/Exception/MessageDoesNotExistException.php');
// require(DOCROOT.'/modules/email/imapclient/Message/EmailAddress.php');
// require(DOCROOT.'/modules/email/imapclient/Exception/MessageDeleteException.php');
// require(DOCROOT.'/modules/email/imapclient/Exception/MessageMoveException.php');
