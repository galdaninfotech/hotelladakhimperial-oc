...
use Galdan\Email\Classes\ImapClient\Exception\AuthenticationFailedException;
use Galdan\Email\Classes\ImapClient\Connection;

/*require(DOCROOT.'/modules/email/imapclient/Exception/AuthenticationFailedException.php');
require(DOCROOT.'/modules/email/imapclient/Connection.php');*/
