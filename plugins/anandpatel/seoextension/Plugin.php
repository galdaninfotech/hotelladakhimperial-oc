...
class Plugin extends PluginBase
{
    ...
    {
        return [
            'AnandPatel\SeoExtension\Components\TourPost' => 'SeoTourPost',
    ...
    public function register()
    {
        ...
        \Event::listen('backend.form.extendFields', function($widget)
        {
            ...
            if(PluginManager::instance()->hasPlugin('Galdan.Pages') && $widget->model instanceof \Galdan\Pages\Classes\Page)
            {
                $widget->addFields([
                        'viewBag[seo_title]' => [
                        'label'   => 'Meta Title',
            ...
            if(PluginManager::instance()->hasPlugin('Galdan.Tour') && $widget->model instanceof \Galdan\Tour\Models\Post)
            {
                $widget->addFields([
                        'seo_title' => [
                            'label'   => 'Meta Title',
