...
return [
    'plugin' => [
        'name' =>  'SEO Extension',
        'description' => 'Provide SEO Extension to October CMS Pages, Static Pages, Tour post'
    ],
    'settings' => [
        'label' => 'SEO Extension',
        ...
        'tab_settings' => [
            ...
            'sitename_comment' => 'Site name | <seo/page/tour title>',
    ...
    'component' => [
        'tour' => [
            'name' => 'SEO Tour Post',
            'description' => 'Inject SEO Fields of tour post'
        ],
        'cms' => [
            'name' => 'SEO CMS Page',
