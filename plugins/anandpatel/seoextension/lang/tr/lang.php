...
return [
    'plugin' => [
        'name' =>  'SEO Eklentisi',
        'description' => 'Sayfalar, Sabit Sayfalar ve Tour yazıları için SEO işlemleri yapar.'
    ],
    'settings' => [
        'label' => 'SEO Eklentisi',
        ...
        'tab_settings' => [
            ...
            'sitename_comment' => 'Site adı | <seo/sayfa/tour başlık>',
    ...
    'component' => [
        'tour' => [
            'name' => 'SEO Tour Gönderisi',
            'description' => 'Tour yazısına SEO alanlarını enjekte et'
        ],
        'cms' => [
