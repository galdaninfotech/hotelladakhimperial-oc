...
return [
    'plugin' => [
        'name' =>  'SEO Rozšíření',
        'description' => 'Poskytuje SEO rozšíření pro CMS stránky, statické stránky a tourové články',
    ],
    'settings' => [
        'label' => 'SEO Rozšíření',
        ...
        'tab_settings' => [
            ...
            'sitename_comment' => 'Název stránek | <nadpis seo/stránky/touru>',
    ...
    'component' => [
        'tour' => [
            'name' => 'SEO Tourového článku',
            'description' => 'Přidá SEO pole k tourovému článku',
        ],
        'cms' => [
